...
2. Carga el esquema de cualquier ejercicio:
   ...
   docker compose -f _scripts/docker-compose.yml exec -T postgres \
     psql -U bootcamp -d bootcamp_db < bootcamp/week-20/2-practicas/ejercicio-01/starter/setup.sql
   ```
3. Conéctate:
   ```bash
...
|-------------|--------|-------------|
| [Triggers](../week-19/README.md) | [Bootcamp](../../README.md) | [Full-Text Search](../week-21/README.md) |
